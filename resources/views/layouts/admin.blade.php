...
<head>
    ...
    <title>NFC</title>
    <link rel="apple-touch-icon" href="{{asset("app-assets/images/logo/download.png")}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset("app-assets/images/logo/download.png")}}">
